...
export function FeatureCard({ icon: Icon, title, description, delay = 0 }: FeatureCardProps) {
  ...
  return (
    <motion.div
      ...
      className="bg-white dark:bg-gradient-to-br dark:from-purple-900/40 dark:to-black/40 border border-purple-200 dark:border-purple-600/30 rounded-xl p-6 hover:border-purple-400 dark:hover:border-purple-500/60 transition-all shadow-sm dark:shadow-none">
